/*
To do:
- Have to figure out how the other code works
- And also implement i2c

- Connect rotation direction instruction to the pwm part of the code
- Figure out parameter for display update
- Determine the correct values for seconds_rotate_180
